...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <ul class="nav navbar-nav navbar-right">
          <li class="dropdown">
            <a>
              Tổng đã kiếm được hôm nay: <b><span id="totalEarnedToday"></span> vnđ</b>
            </a>
          </li>
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <!---<li>
                                ...
                                <li class="divider"></li>--->
              <li><a href="<?= site_url('logout') ?>"><i class="fa fa-sign-out"></i> Đăng xuất</a></li>
            </ul>
          </li>
        </ul>
      </div><!-- /.navbar-collapse -->
  ...
  <footer class="container-fluid text-center hidden-print">
    <p>
      ...
      Copyright <a href="#">Admin</a> (2021 - <?= date('Y') ?>)
    </p>
  </footer>
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-header hidden-print">
          ...
          <h4 class="text-center">Biên nhận giao dịch</h4>
        </div>
          ...
          <form name="logInModalForm">
            <div class="row">
              <div class="col-sm-12 form-group">
                <label for='logInModalEmail' class="control-label">Email</label>
                <input type="email" id='logInModalEmail' class="form-control checkField" placeholder="Email" autofocus>
                <span class="help-block errMsg" id="logInModalEmailErr"></span>
              </div>
              <div class="col-sm-12 form-group">
                <label for='logInPassword' class="control-label">Mật khẩu</label>
                <input type="password" id='logInModalPassword' class="form-control checkField" placeholder="Mật khẩu">
            ...
            <div class="row">
              ...
              <div class="col-sm-2 pull-right">
                <button id='loginModalSubmit' class="btn btn-primary">Đăng nhập</button>
              </div>
            </div>
          </form>
        </div>
