...
<body>
    ...
    <table style="text-align: left">
        <tbody>
            ...
            <tr>
                <th>Giới tính:</th>
                <td></td>
                <td><?= $this->input->post('gender') == "M" ? "Nam" : "Nữ" ?></td>
            </tr>
            <tr>
                <th>Số tiền gửi:</th>
                <td></td>
                <td><?= number_format($this->input->post('amountDeposited'), 0) ?> vnđ</td>
            </tr>
            <tr>
                <th>Đường:</th>
                <td></td>
    ...
    <p>Chúng tôi mong bạn thích thời gian cùng với chúng tôi.</p>
