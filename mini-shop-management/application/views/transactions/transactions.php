            ...
            <div class="row">
                <div class="col-sm-3">
                    <span class="pointer text-primary">
                        <button class='btn btn-primary btn-sm' id='showTransForm'><i class="fa fa-plus"></i> Giao dịch mới </button>
                    </span>
                </div>
                <div class="col-sm-3">
                    <span class="pointer text-primary">
                        <button class='btn btn-primary btn-sm' data-toggle='modal' data-target='#reportModal'>
                            <i class="fa fa-newspaper-o"></i> Tạo báo cáo
                        </button>
                    </span>
                </div>
            </div>
                ...
                <div class="col-sm-12" id="salesTransFormDiv">
                    <div class="well">
                        <form name="salesTransForm" id="salesTransForm" role="form">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3 form-group-sm">
                                            <label for="discount">Chiết khấu(giá trị)</label>
                                        ...
                                        <div class="col-sm-3 form-group-sm">
                                            ...
                                            <select class="form-control checkField" id="modeOfPayment">
                                                ...
                                                <option value="POS">Thẻ tín dụng</option>
                                                <option value="Cash and POS">Tiền mặt hoặc thẻ tín dụng</option>
                                            </select>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4 form-group-sm">
                                            <label for="changeDue">Thay đổi do</label>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4 form-group-sm">
                                            ...
                                            <input type="text" id="custName" class="form-control" placeholder="Tên">
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-2 form-group-sm">
                                    <button class="btn btn-primary btn-sm" id='useScanner'>Sử dụng máy quét mã vạch</button>
                                </div>
                                <br class="visible-xs">
                                <div class="col-sm-6"></div>
                                <br class="visible-xs">
                                <div class="col-sm-4 form-group-sm">
                                    <button type="button" class="btn btn-primary btn-sm" id="confirmSaleOrder">Xác nhận đơn hàng</button>
                                    <button type="button" class="btn btn-danger btn-sm" id="cancelSaleOrder">Làm mới đơn hàng</button>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="col-sm-3 form-inline form-group-sm">
                        <label for="transListPerPage">Trang</label>
                    ...
                    <div class="col-sm-5 form-group-sm form-inline">
                        <label for="transListSortBy">Lọc bởi</label>
                        <select id="transListSortBy" class="form-control">
                            <option value="transId-DESC">Ngày (Mới nhất đầu tiên)</option>
                            <option value="transId-ASC">Ngày (Cũ nhất đầu tiên)</option>
                            <option value="quantity-DESC">Số lượng (Cao nhất trước)</option>
                            <option value="quantity-ASC">Số lượng (Thấp nhất trước)</option>
                            <option value="totalPrice-DESC">Tổng giá (Cao nhất trước)</option>
                            <option value="totalPrice-ASC">Tổng giá (Thấp nhất trước)</option>
                            <option value="totalMoneySpent-DESC">Tổng số tiền đã chi (Cao nhất trước)</option>
                            <option value="totalMoneySpent-ASC">Tổng số tiền đã chi (Thấp nhất trước)</option>
                        </select>
                    </div>

                    <div class="col-sm-4 form-inline form-group-sm">
                        <label for='transSearch'><i class="fa fa-search"></i></label>
                        <input type="search" id="transSearch" class="form-control" placeholder="Tìm giao dịch">
                    </div>
                </div>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="text-center">Tạo báo cáo</h4>
            </div>
            ...
            <div class="modal-footer">
                <button class="btn btn-success" id='clickToGen'>Tạo</button>
