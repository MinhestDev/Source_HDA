            ...
            <div class="container">
                        ...
                        <div class="form-bottom">
                            <form id="loginForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" placeholder="Mật khẩu" class="form-control checkField" id="password">
                                </div>
                ...
                <div class="row">
                    <div class="col-sm-12 text-center" style="color:white">
                        Designed and Developed by <a href="#" target='_blank' class="text-primary">Admin</a> (2022)
                    </div>
                </div>
            </div>
        </div>
