        ...
        <div class="panel panel-info">
            <div class="panel-body latestStuffsBody" style="background-color: #5cb85c">
                ...
                <div class="pull-right">
                    ...
                    <div class="latestStuffsText">Tổng doanh số hôm nay</div>
                </div>
            </div>
            <div class="panel-footer text-center" style="color:#5cb85c">Số mặt hàng đã bán hôm nay</div>
        </div>
    </div>
    <div class="col-sm-4">
        <div class="panel panel-info">
            <div class="panel-body latestStuffsBody" style="background-color: #f0ad4e">
                ...
                <div class="pull-right">
                    ...
                    <div class="latestStuffsText pull-right">Tổng số giao dịch</div>
                </div>
            </div>
            <div class="panel-footer text-center" style="color:#f0ad4e">Tổng số giao dịch mọi thời gian</div>
        </div>
    </div>
    <div class="col-sm-4">
        <div class="panel panel-info">
            <div class="panel-body latestStuffsBody" style="background-color: #337ab7">
                ...
                <div class="pull-right">
                    <div><?= $totalItems ?></div>
                    <div class="latestStuffsText pull-right">Các mặt hàng trong kho</div>
                </div>
            </div>
            <div class="panel-footer text-center" style="color:#337ab7">Tổng số mặt hàng trong kho</div>
        </div>
    </div>
</div>
...
<div class="row margin-top-5">
    <div class="col-sm-3">
        <div class="panel panel-hash">
            <div class="panel-heading"><i class="fa fa-cart-plus"></i> NHU CẦU CAO</div>
            <?php if ($topDemanded) : ?>
    ...
    <div class="col-sm-3">
        <div class="panel panel-hash">
            <div class="panel-heading"><i class="fa fa-cart-arrow-down"></i> NHU CẦU THẤP</div>
    ...
    <div class="col-sm-3">
        <div class="panel panel-hash">
            <div class="panel-heading"><i class="fa fa-money"></i> THU NHẬP CAO NHẤT</div>
                ...
                <table class="table table-striped table-responsive table-hover">
                    ...
                    <tbody>
                        <?php foreach ($highestEarners as $get) : ?>
                            <tr>
                                <td><?= $get->name ?></td>
                                <td><?= number_format($get->totEarned, 0) ?> vnđ</td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
    ...
    <div class="col-sm-3">
        <div class="panel panel-hash">
            <div class="panel-heading"><i class="fa fa-money"></i> THU NHẬP THẤP NHẤT</div>
...
<div class="row">
                        ...
                        <tbody>
                            <?php foreach ($dailyTransactions as $get) : ?>
                                <tr>
                                    ...
                                    <td><?= $get->qty_sold ?></td>
                                    <td><?= $get->tot_trans ?></td>
                                    <td><?= number_format($get->tot_earned, 0) ?> vnđ</td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
    ...
    <div class="col-sm-6">
        <div class="panel panel-hash">
            <div class="panel-heading">Giao dịch ngày</div>
            <div class="panel-body scroll panel-height">
...
<div class="row">
    <div class="col-sm-6">
        <div class="panel panel-hash">
            <div class="panel-heading">Giao dịch tháng</div>
            <div class="panel-body scroll panel-height">
    ...
    <div class="col-sm-6">
        <div class="panel panel-hash">
            <div class="panel-heading">Giao dịch năm</div>
            <div class="panel-body scroll panel-height">
