            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="col-sm-3 form-inline form-group-sm">
                        <label for="adminListPerPage">Hiển thị</label>
                        ...
                        <label for="adminListPerPage">trên trang</label>
                    </div>
                    <div class="col-sm-4 form-inline form-group-sm">
                        <label for="adminListSortBy" class="control-label">Lọc bởi</label>
                        <select id="adminListSortBy" class="form-control">
                            <option value="first_name-ASC" selected>Tên (A to Z)</option>
                            <option value="first_name-DESC">Tên (Z to A)</option>
                            <option value="created_on-ASC">Ngày đã tạo (trước đây)</option>
                            <option value="created_on-DESC">Ngày đã tạo (gần đây)</option>
                    ...
                    <div class="col-sm-3 form-inline form-group-sm">
                        ...
                        <input type="search" id="adminSearch" placeholder="Tìm kiếm...." class="form-control">
                    </div>
                </div>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class='modal-header'>
                ...
                <h4 class="text-center">Thêm Admin mới</h4>
                ...
                <form id='addNewAdminForm' name='addNewAdminForm' role='form'>
                    <div class="row">
                        <div class="form-group-sm col-sm-6">
                            ...
                            <input type="text" id='firstName' class="form-control checkField" placeholder="Họ">
                            <span class="help-block errMsg" id="firstNameErr"></span>
                        </div>
                        <div class="form-group-sm col-sm-6">
                            <label for='lastName' class="control-label">Tên</label>
                            <input type="text" id='lastName' class="form-control checkField" placeholder="Tên">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group-sm col-sm-6">
                            <label for='role' class="control-label">Phân quyền</label>
                            <select class="form-control checkField" id='role'>
                                <option value=''>Phân quyền</option>
                                <option value='Super'>Cấp cao</option>
                    ...
                    <div class="row">
                        <div class="form-group-sm col-sm-6">
                            ...
                            <input type="tel" id='mobile1' class="form-control checkField" placeholder="Số điện thoại">
                            <span class="help-block errMsg" id="mobile1Err"></span>
                        </div>
                        <div class="form-group-sm col-sm-6">
                            <label for='mobile2' class="control-label">Số điện thoại khác</label>
                            <input type="tel" id='mobile2' class="form-control" placeholder="Số điện thoại khác">
                    ...
                    <div class="row">
                        <div class="form-group-sm col-sm-6">
                            <label for="passwordOrig" class="control-label">Mật khẩu:</label>
                            <input type="password" class="form-control checkField" id="passwordOrig" placeholder="Mật khẩu">
                            <span class="help-block errMsg" id="passwordOrigErr"></span>
                        </div>
                        <div class="form-group-sm col-sm-6">
                            <label for="passwordDup" class="control-label">Nhập lại mật khẩu:</label>
                            <input type="password" class="form-control checkField" id="passwordDup" placeholder="Nhập lại mật khẩu">
            ...
            <div class="modal-footer">
                <button type="reset" form="addNewAdminForm" class="btn btn-warning pull-left">Làm mới thông tin</button>
                <button type='button' id='addAdminSubmit' class="btn btn-primary">Thêm Admin</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id='editAdminForm' name='editAdminForm' role='form'>
                    <div class="row">
                        <div class="form-group-sm col-sm-6">
                            <label for='firstNameEdit' class="control-label">Họ</label>
                            <input type="text" id='firstNameEdit' class="form-control checkField" placeholder="Họ">
                            <span class="help-block errMsg" id="firstNameEditErr"></span>
                        </div>
                        <div class="form-group-sm col-sm-6">
                            <label for='lastNameEdit' class="control-label">Tên</label>
                            <input type="text" id='lastNameEdit' class="form-control checkField" placeholder="Tên">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group-sm col-sm-6">
                            <label for='roleEdit' class="control-label">Phân quyền</label>
                    ...
                    <div class="row">
                        <div class="form-group-sm col-sm-6">
                            <label for='mobile1Edit' class="control-label">Số điện thoại</label>
                            <input type="tel" id='mobile1Edit' class="form-control checkField" placeholder="Số điện thoại">
                            <span class="help-block errMsg" id="mobile1EditErr"></span>
                        </div>
                        <div class="form-group-sm col-sm-6">
                            <label for='mobile2Edit' class="control-label">Số điện thoại khác</label>
                            <input type="tel" id='mobile2Edit' class="form-control" placeholder="Số điện thoại khác">
            ...
            <div class="modal-footer">
                <button type="reset" form="editAdminForm" class="btn btn-warning pull-left">Làm mới thông tin</button>
                <button type='button' id='editAdminSubmit' class="btn btn-primary">Cập nhật</button>
                <button type='button' class="btn btn-danger" data-dismiss='modal'>Đóng</button>
            </div>
        </div>
    </div>
