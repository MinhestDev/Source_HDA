...
class Dashboard extends CI_Controller
{
  ...
  public function earningsGraph($year = "", $not_ajax = false)
  {
    ...
    $dataarr = [];
    $allMonths = ["Tháng 1", "Tháng 2", "Tháng 3", "Tháng 4", "Tháng 5", "Tháng 6", "Tháng 7", "Tháng 8", "Tháng 9", "Tháng 10", "Tháng 11", "Tháng 12"];
    ...
    //add info into array
    $json = array("Tổng tiền" => $dataarr, 'earningsYear' => $year_to_fetch);
